...
# setting path
sys.path.append('./src/')
amsadfreader    = __import__("ams-adf-reader")
...
measurement = Measurement(measurementFile)
...
assert(print("Measurement step size      :", measurement.stepSize))        == None
assert(print("Measurement scan size      :", measurement.scanSize))        == None
assert(print("Measurement frequency size :", measurement.freqSize))        == None
